                  ...
                  return (
                    <div key={l.id} role="button" tabIndex={0}
                      ...
                      <span className="flex-shrink-0 text-[11px] font-semibold px-3 py-1 rounded-full relative z-10"
                        ...
                        {isComp ? "Completed" : isActive ? "Current" : "<svg xmlns="http://www.w3.org/2000/svg" className="inline-block" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#A78BFA" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" opacity="0.5" aria-hidden="true"><rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 018 0v4"/></svg>"}
                      </span>
                    </div>
                  );
                })}
                  ...
                  <div key={l.id} className={`flex gap-4 relative ${isLast ? "" : "mb-5"}`}
                    ...
                    <div className="flex-1 min-w-0 flex items-center justify-between" style={{ height: 52 }}>
                      ...
                      <span className="flex-shrink-0 text-[11px] font-medium px-3 py-1 rounded-full text-center transition-colors duration-300"
                        ...
                        {isComp ? "Done" : isActive ? "Current" : "<svg xmlns="http://www.w3.org/2000/svg" className="inline-block" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#A78BFA" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" opacity="0.5" aria-hidden="true"><rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 018 0v4"/></svg>"}
                      </span>
                    </div>
                  </div>
                );
              ...
              <div className="flex gap-4 relative" style={{ minHeight: 52 }}>
                ...
                <div className="flex-1 min-w-0 flex items-center justify-between" style={{ height: 52 }}>
                  ...
                  <span className="flex-shrink-0 text-[11px] font-medium px-3 py-1 rounded-full text-center transition-colors duration-300"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="inline-block" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#A78BFA" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" opacity="0.5" aria-hidden="true"><rect x="5" y="11" width="14" height="10" rx="2"/><path d="M8 11V7a4 4 0 018 0v4"/></svg>
                  </span>
                </div>
              </div>
            </div>
